...
* [GitHub Repo](https://github.com/imba/imba) ⭐ 6,509 | 🐛 166 | 🌐 JavaScript | 📅 2026-09-16
...
* [Hello World Imba](https://github.com/imba/hello-world-imba) ⚠️ Archived - Official Imba "Hello World" example. Also you can use it as GitHub template.
* [Start Imba](https://github.com/athif23/start-imba) ⭐ 22 | 🐛 40 | 🌐 JavaScript | 📅 2026-02-15 - Tool to bootstrap an Imba protect that was inspired by Create React App and Vue CLI.
* [Imba Router](https://github.com/somebee/imba-router) ⭐ 20 | 🐛 14 | 🌐 JavaScript | 📅 2022-12-08 - Experimental router for Imba.
* [Material Imba](https://github.com/nathanjohnson320/material-imba) ⚠️ Archived - Material Design components written in Imba.
* [Imba Shell](https://github.com/donaldp/imba-shell) ⭐ 16 | 🐛 1 | 🌐 Imba | 📅 2025-04-20 - Interactive debugger and REPL for Imba.
* [UXA](https://github.com/somebee/uxa) ⭐ 13 | 🐛 8 | 🌐 JavaScript | 📅 2022-12-08 - Experimental framework for Imba.
* [Imba Inertia Adapter](https://github.com/haikyuu/imba-inertia-adapter) ⭐ 12 | 🐛 6 | 🌐 TypeScript | 📅 2022-08-30 - Imba [Inertia](https://inertiajs.com) adapter.
* [Parcel Plugin Imba](https://github.com/imba/parcel-plugin-imba) ⭐ 9 | 🐛 1 | 🌐 JavaScript | 📅 2018-12-01 - [Parcel Bundler](https://parceljs.org/) plugin to enable
  processing of Imba files.
* [Formidable](https://www.formidablejs.org/) - Imba Framework for Rapid API Development.

#### Editor Plugins and IDEs

* [Sublime Text](http://github.com/somebee/sublime-imba) ⭐ 15 | 🐛 5 | 🌐 Python | 📅 2020-05-03 - Imba plugin for Sublime.
* [VSCode](http://github.com/somebee/vscode-imba) ⚠️ Archived - Imba plugin for VSCode.
* [Atom](http://github.com/somebee/language-imba) ⭐ 2 | 🐛 0 | 📅 2017-10-19 - Imba plugin for Atom.
...
* [html2imba](https://github.com/konsumer/html2imba) ⭐ 5 | 🐛 1 | 🌐 JavaScript | 📅 2018-12-02 - [view online](http://konsumer.js.org/html2imba/) - A tool to convert HTML to Imba tag source.
* [RegExp Explorer](https://github.com/taw/imba-regexp-explorer) ⭐ 2 | 🐛 0 | 🌐 Imba | 📅 2026-01-22 - [view online](https://taw.github.io/imba-regexp-explorer) - Regex tool.
* [JSON pretty printer](https://github.com/taw/imba-json-beautifier) ⭐ 1 | 🐛 0 | 🌐 JavaScript | 📅 2026-02-14 - [view online](https://taw.github.io/imba-json-beautifier) - JSON prettier.
* [Monoalphabetic Cipher Decoder](https://github.com/taw/imba-monoalphabetic) ⭐ 0 | 🐛 0 | 🌐 Imba | 📅 2026-01-22 - [view online](https://taw.github.io/imba-monoalphabetic) - Decoder for monoalphabetic cipher.

#### Apps/Websites

* [Imba Todo MVC](https://github.com/somebee/todomvc-imba) ⭐ 23 | 🐛 0 | 🌐 JavaScript | 📅 2016-12-30 -  Imba TodoMVC Example.
* [Ping CRM](https://github.com/haikyuu/perfect-stack) ⭐ 22 | 🐛 3 | 🌐 Imba | 📅 2023-04-13 - CRUD app with login, acccount, organizations and contacts management. Built with Inertia, Edgedb and Imba
* [Imba Realworld App](https://github.com/cartonalexandre/imba-realworld-example-app) ⭐ 16 | 🐛 0 | 🌐 Imba | 📅 2024-07-06 - [view online](https://imba-realworld-example-app.netlify.com/) - Project was created to demonstrate a fully fledged fullstack application that adheres to the [RealWorld](https://github.com/gothinkster/realworld) ⭐ 84,226 | 🐛 28 | 🌐 TypeScript | 📅 2026-08-26 spec and API.
...
* [Top Down Shooter](https://github.com/CassianoSF/imba-top-down-shooter) ⭐ 7 | 🐛 7 | 🌐 CSS | 📅 2023-07-11 - [view online](https://cassianosf.github.io/imba-top-down-shooter/dist/index.html) - 2D zombie shooter game.
* [Eyes](https://github.com/taw/imba-eyes) ⭐ 4 | 🐛 0 | 🌐 Imba | 📅 2026-01-22 - [view online](https://taw.github.io/imba-eyes) - A cool interaction website.
* [Fifteen Puzzle](https://github.com/taw/imba-fifteen) ⭐ 4 | 🐛 0 | 🌐 Imba | 📅 2026-01-22 - [view online](https://taw.github.io/imba-fifteen) - Fifteen puzzle.
* [Matrix Rain](https://github.com/taw/imba-matrix-rain) ⭐ 3 | 🐛 0 | 🌐 Imba | 📅 2026-01-22 - [view online](https://taw.github.io/imba-matrix-rain) - Cool matrix-like rain animation.
* [Snake Game](https://github.com/taw/imba-snake) ⭐ 3 | 🐛 0 | 🌐 Imba | 📅 2026-01-22 - [view online](https://taw.github.io/imba-snake) - Snake game.
...
* [Other Todo MVC](https://github.com/shapkarin/imba-todo) ⭐ 1 | 🐛 0 | 🌐 CSS | 📅 2019-08-07 - [view online](https://shapkarin.github.io/imba-todo/) - TodoMVC implementation following [tastejs/todomvc](https://github.com/tastejs/todomvc) ⭐ 28,959 | 🐛 73 | 🌐 JavaScript | 📅 2026-06-06 rules.
